...
# Slightly modified by Harry Hacker
...
vq_parser.add_argument("-conf", "--vqgan_config", type=str, help="VQGAN config", default=f'packages\checkpoints/vqgan_imagenet_f16_16384.yaml', dest='vqgan_config')
vq_parser.add_argument("-ckpt", "--vqgan_checkpoint", type=str, help="VQGAN checkpoint", default=f'packages\checkpoints/vqgan_imagenet_f16_16384.ckpt', dest='vqgan_checkpoint')
...
vq_parser.add_argument("-o",    "--output", type=str, help="Output image filename", default=r"results\generated_image.png", dest='output')
