...
import java.sql.*;
/**
 * Class to easily return the next available Appointment ID.
 */
public class AIDFinder
{
    ...
    {   
        try {
            ...
            ResultSet resultStatement = statement.executeQuery("SELECT `Appointment ID` FROM `Appointments Table`");
            int returnedValue = 0;
